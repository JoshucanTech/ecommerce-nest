...
export class DeliveriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new delivery for an order. Only administrators and vendors can create deliveries.',
  })
  @ApiHeader({
    name: 'Authorization',
  ...
  @ApiResponse({
    status: 403,
    description:
      'Forbidden - Insufficient permissions (admin or vendor role required)',
  })
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of all deliveries in the system. Only accessible by administrators.',
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
