...
export class AuthController {
  ...
  @ApiOperation({ 
    ...
    description: "Create a new user account with email and password. The user will be assigned the BUYER role by default unless specified otherwise."
  })
  @ApiBody({
  ...
  @ApiOperation({ 
    ...
    description: "Authenticate a user with email and password to obtain access and refresh tokens."
  })
  @ApiBody({
  ...
  @ApiOperation({ 
    ...
    description: "Obtain a new access token using a valid refresh token. This extends the user session without requiring re-authentication."
  })
  @ApiHeader({
    name: 'Authorization',
  ...
  @ApiOperation({ 
    ...
    description: "Retrieve the profile information of the currently authenticated user, including associated data like addresses, settings, and role-specific information."
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
  ...
  @ApiOperation({ 
    ...
    description: "Invalidate the refresh token for the currently authenticated user, effectively logging them out of the application."
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
  ...
  @ApiResponse({ status: 200, description: "User logged out successfully", content: {
    'application/json': {
      schema: {
        type: 'object',
        properties: {
  ...
  @ApiOperation({ 
    ...
    description: "Initiate the Google OAuth2 authentication flow. This endpoint redirects the user to Google for authentication."
  })
  @ApiResponse({
    status: 302,
  ...
  @ApiOperation({ 
    ...
    description: "Handle the callback from Google OAuth2 authentication and return access and refresh tokens."
  })
  @ApiResponse({
    status: 200,
