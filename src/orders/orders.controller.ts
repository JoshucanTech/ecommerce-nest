...
export class OrdersController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new order with multiple products from different vendors. The system will automatically split the order by vendor and create separate orders for each vendor.',
  })
  @ApiHeader({
    name: 'Authorization',
  ...
  @ApiResponse({
    status: 400,
    description: "Bad request - Invalid input data's",
  })
  @ApiResponse({
    status: 401,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve a paginated list of orders for the currently authenticated user.',
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
