...
export class CategoriesController {
  ...
  @ApiOperation({
    ...
    description:
      'Create a new product category. Only administrators can create categories.',
  })
  @ApiHeader({
    name: 'Authorization',
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve all product categories in a hierarchical structure with subcategories and product counts.',
  })
  @ApiResponse({
    status: 200,
  ...
  @ApiOperation({
    ...
    description:
      'Retrieve detailed information about a specific category by its ID or slug, including parent category, subcategories, and featured products.',
  })
  @ApiParam({
    name: 'id',
  ...
  @ApiOperation({
    ...
    description:
      'Update an existing product category. Only administrators can update categories.',
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
  ...
  @ApiOperation({
    ...
    description:
      'Delete a product category. Only administrators can delete categories.',
  })
  @ApiHeader({
    name: 'Authorization',
    description: 'Bearer token for authentication',
