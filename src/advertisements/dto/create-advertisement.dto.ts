...
export class ProductAdvertisementDto {
  ...
  @ApiPropertyOptional({
    example: 'Limited time offer for our summer collection',
  })
  @IsOptional()
  @IsString()
...
export class CreateAdTargetingDto {
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['Sports', 'Technology', 'Fashion'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['sale', 'discount', 'new arrival'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  ...
  @ApiPropertyOptional({
    type: Object,
    example: { facebookAudienceId: '123456789' },
  })
  @IsOptional()
...
export class CreateAdvertisementDto {
  ...
  @ApiPropertyOptional({
    example: 'Promote our summer collection with special discounts',
  })
  @IsOptional()
  @IsString()
  description?: string;
  ...
  @ApiPropertyOptional({
    example: 5,
    description: 'Maximum number of products this ad can hold',
  })
  @IsOptional()
  @IsNumber()
  @Min(1)
  ...
  @ApiPropertyOptional({
    ...
    description: 'Products to include in this advertisement',
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiProperty({
    example: 1000,
    description: 'Total budget for the ad campaign',
  })
  @IsNumber()
  @Min(1)
  budget: number;
  ...
  @ApiProperty({
    enum: AdType,
    example: AdType.FEATURED_PRODUCT,
    description: 'Ad type',
  })
  @IsEnum(AdType)
  type: AdType;
  ...
  @ApiProperty({
    example: 0.5,
    description: 'Bid amount per click/view based on pricing model',
  })
  @IsNumber()
  @Min(0.01)
  bidAmount: number;
  ...
  @ApiPropertyOptional({
    type: [String],
    example: ['IN_APP', 'FACEBOOK', 'INSTAGRAM'],
  })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
